...
optimizer = FastAdaBelief([{'params': dualnet.net1.parameters()},
                           {'params': dualnet.net2.parameters()}] , lr=args.lr)
...
optimizer_SOP = optim.SGD([{'params': SOP1.u, 'lr': 1, 'weight_decay':0},
                        {'params': SOP1.v, 'lr': 10, 'weight_decay':0},
                        {'params': SOP2.u, 'lr': 1, 'weight_decay':0},
                        {'params': SOP2.v, 'lr': 10, 'weight_decay':0}])
...
for epoch in range(args.num_epochs + 1):
    ...
    if epoch < warm_up:
        ...
        print('Warmup Net1')
        warmup(epoch, dualnet.net1, dualnet.net2, optimizer, optimizer_SOP, warmup_trainloader)
    if True:
        ...
        pi1,pi2,pi1_unrel,pi2_unrel = train(epoch,dualnet.net1, dualnet.net2, optimizer, optimizer_SOP, total_trainloader,pi1,pi2,pi1_unrel,pi2_unrel) 
